...
contract NitroProverTest is Test {
    ...
    function setUp() public {
        vm.warp(1742673000); // timestamp: date -d '2025-03-22 20:50:00 UTC' +%s
        nitroProver = INitroProver(0x17d9C6366D927AC66436F7CfAD9402279aa46dC1);
    }
    ...
    function test_VerifyMyAttestation() public {
        ...
        // @dev if PCR4 is included (pcr4 = hashed user data field) set bitmask to hex"00000017"
            hex"00000017", // bitmask for PCR0, PCR1, PCR2, PCR4 
        ...
        nitroProver.verifyAttestation(attestation, pcrs, 365 days);
    }
}
